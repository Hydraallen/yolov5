...
device = torch.device("mps") # Use GPU on Mac with Apple M1 chip
...
def parse_opt(known=False):
    ...
    parser.add_argument("--data", type=str, default=ROOT / "./DataSets_Mask_Mac/data/mask.yaml", help="dataset.yaml path")
